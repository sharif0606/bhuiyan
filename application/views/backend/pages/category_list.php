    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2> <a href="<?php echo base_url(); ?>add-category" class="btn btn-primary"> <i class="fa fa-plus" aria-hidden="true"></i>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($all_category_info as $data) { ?>
                                        ...
                                        <tr class="even pointer">
                                            <td class=" "><?= $data->category_id; ?></td>
                                            <td class=" "><?= $data->category_name; ?></td>
                                            <td><img src="<?= base_url().$data->category_image;?>" width="70" height="40"></td>
                                            <td><?= $type[$data->category_type];?></td>
                                            <td><?= $showF[$data->show_front];?></td>
                                            <td class=" last">
                                                <a href="<?= base_url(); ?>edit-category/<?= $data->category_id; ?>" class="btn btn-info btn-xs"> <i class="glyphicon glyphicon-pencil"></i> Edit</a>
