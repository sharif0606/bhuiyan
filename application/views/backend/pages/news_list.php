            ...
            <div class="title_right">
                <div class="col-md-4 col-sm-4 col-xs-12 form-group pull-right top_search">
                    <div class="input-group">
                        <form action="<?php echo base_url();?>search/backend_blog_search" method="POST">
                ...
                <?php $cond=array(0=>"",1=>"Refurbished",2=>"New product") ?>
                    <?php foreach ($results as $data) { ?>
                        <tr>
                            ...
                            <td>
                                <?php echo $cond[$data->condition_p];?>
                                <?= $data->new_item==1?"<br> New Item":"" ?>
                                <?= $data->popular_item==1?"<br> Popular Item":"" ?>
                            </td>
